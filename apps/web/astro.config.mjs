  ...
  integrations: [
    starlight({
      ...
      sidebar: [
        ...
        { label: 'Overview', link: '/' },
        // Release notes and design write-ups. Newest first, which `sidebar.order` gives us by
        // counting down rather than up.
        { label: 'Blog', items: [{ autogenerate: { directory: 'blog' } }] },
        { label: 'Start here', items: [{ autogenerate: { directory: 'start' } }] },
        // Autogenerated from `sidebar.order` in each page's frontmatter rather than listed here.
