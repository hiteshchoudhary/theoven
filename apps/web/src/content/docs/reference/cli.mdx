...
rather than at the config. This refuses to start instead, and lists **every** problem at once —
fixing environment configuration one variable per restart is a genuinely awful way to spend
twenty minutes.
