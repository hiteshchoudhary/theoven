...
`oven db` needs a migration toolchain in the project and `oven worker` needs the
[`queue`](/docs/bricks/queue/) brick registered. Neither guesses: a project without one gets a
